    ...
    <section className="relative overflow-hidden bg-primary py-24 text-primary-foreground md:py-32">
      ...
      <div className="relative mx-auto max-w-6xl px-5 md:px-8">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.22em] text-primary-foreground/90">
          ...
          {processSteps.map((step) => (
            ...
            >
              <div className="flex items-baseline gap-3">
                ...
                {step.pairHint && (
                  <span className="hidden text-[10px] uppercase tracking-[0.18em] text-primary-foreground/92 md:inline">
                    Tipp
                  </span>
                )}
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-sm font-medium uppercase tracking-[0.14em] text-primary-foreground/85">
                  {step.subtitle}
                </p>
              ...
              <div>
                ...
                <p className="mt-6 border-t border-primary-foreground/15 pt-4 text-sm leading-relaxed text-primary-foreground/90">
                  <span className="font-semibold uppercase tracking-[0.14em] text-primary-foreground/90">
                    Ergebnis ·{" "}
                  </span>
                  {step.result}
                </p>
                {step.pairHint && (
                  <p className="mt-3 text-xs italic text-primary-foreground/85">
                    Tipp: {step.pairHint}
                  </p>
                )}
              </div>
