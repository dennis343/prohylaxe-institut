import type { User, Contact, Campaign, Transaction } from './types'
...
function generateContacts(
  ...
  return Array.from({ length: total }, (_, i) => ({
    ...
    industry: weightedPick(industryWeights, rand()),
    segment: weightedPick(segmentWeights, rand()),
    type: rand() < b2bRatio ? 'B2B' : 'B2C',
    completeness: Math.min(100, Math.max(20, Math.round(avgCompleteness + (rand() - 0.5) * 50))),
...
export const SEED_CONTACTS: Contact[] = [
  ...generateContacts(
    ...
    200,
    150,
    [['Finanzen', 4], ['Versicherungen', 3], ['Immobilien', 2], ['Consulting & Beratung', 1]],
    [['KMU', 4], ['Mittelstand', 3], ['Freelancer', 2], ['Endkunde', 1]],
    0.7,
    76,
    11,
  ),
  ...generateContacts(
    ...
    120,
    100,
    [['IT & Software', 6], ['Consulting & Beratung', 2], ['Produktion & Industrie', 2]],
    [['Startup', 3], ['KMU', 4], ['Mittelstand', 2], ['Konzern', 1]],
    0.92,
    82,
    22,
  ),
  ...generateContacts(
    ...
    180,
    130,
    [['Marketing & Werbung', 5], ['Handel & Retail', 3], ['Bildung & Coaching', 2]],
    [['KMU', 5], ['Mittelstand', 3], ['Freelancer', 2]],
    0.78,
    66,
    33,
  ),
  ...generateContacts(
    ...
    80,
    60,
    [['Versicherungen', 5], ['Immobilien', 3], ['Gesundheit & Medizin', 2]],
    [['KMU', 4], ['Endkunde', 4], ['Freelancer', 2]],
    0.5,
    71,
    44,
  ),
  ...generateContacts(
    ...
    40,
    30,
    [['Finanzen', 6], ['Bildung & Coaching', 4]],
    [['KMU', 4], ['Freelancer', 4], ['Endkunde', 2]],
    0.6,
    73,
    55,
  ),
...
export const SEED_CAMPAIGNS: Campaign[] = [
  {
    ...
    message:
      'Sehr geehrte Damen und Herren,\n\nim Auftrag der Firma Clara Wendt Marketing lade ich Sie herzlich zu unserem kostenlosen Webinar „Smarte Finanzplanung für KMU" am 15. Mai ein. Profitieren Sie von praxisnahen Tipps und Q&A mit Expertin Anna Bauer.\n\nAnmeldung unter: webinar.beispiel.de',
  ...
  },
  {
    ...
    creatorId: 'ben',
    targetOwnerId: 'clara',
    subject: 'Angebot: IT-Sicherheits-Audit für Marketing-Agenturen',
    message:
      'Guten Tag,\n\nfür Agenturen und digitale Dienstleister bieten wir derzeit einen kostengünstigen IT-Sicherheits-Audit an. Schützen Sie Ihre Kundendaten und DSGVO-konform zu sein. Gerne vereinbaren wir einen unverbindlichen Termin.',
  ...
  },
  {
    ...
    creatorId: 'david',
    targetOwnerId: 'anna',
    subject: 'Spezialangebot: Berufsunfähigkeitsversicherung für Freiberufler',
    message:
      'Liebe Freiberuflerin, lieber Freiberufler,\n\nals unabhängiger Makler habe ich exklusive Konditionen für Berufsunfähigkeitsversicherungen ausgehandelt. Kein Gesundheitsfragebogen bis Ende des Monats. Interesse?\n\nDavid Krause, Tel. 0800-123456',
    filterIndustry: null,
...
export const SEED_TRANSACTIONS: Transaction[] = [
  ...
  // Campaign 1 (clara → anna, abgeschlossen)
  ...
  // Campaign 2 (ben → clara, aktiv)
  { id: 'tx-2a', userId: 'ben',    type: 'kampagne_ausgabe',  amount: -75, description: 'Kampagne „IT-Sicherheits-Audit" gestartet (75 Kontakte)', createdAt: daysAgo(30), relatedCampaignId: 'camp-2' },
  ...
  // Campaign 3 (david → anna, offen – tokens on hold)
  { id: 'tx-3a', userId: 'david',  type: 'kampagne_ausgabe',  amount: -32, description: 'Kampagne „BU-Versicherung Freiberufler" gesendet (32 Kontakte)', createdAt: daysAgo(7), relatedCampaignId: 'camp-3' },
]
